rich_content:
  -
    ...
    html: |
      ...
      <div class="-mx-1 sm:-mx-2 md:-mx-4 pb-6 md:pb-2 "><lite-youtube videoid="ASnzzG0NOF8" onclick="window.open('https://www.youtube.com/watch?v=ASnzzG0NOF8&rel=0', '_blank')" class="mt-8 md:mt-10 md:mb-8" rel="0"></lite-youtube></div>
  -
    type: text
