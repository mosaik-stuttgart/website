rich_content:
  -
    type: html
    html: |
      <style>lite-youtube { background-image: url('/assets/images/pfingsten2020.jpg') !important } </style>
  ...
  -
    type: text
    text: '<p><br>Wir haben auch eine Playlist vorbereitet, damit du nach dem Livestream mit uns zusammen weiter beten und Gott groß machen kannst.</p>'
  -
    type: html
    html: |
